...
layout = dbc.Container([
    ...
    # Графики
    dbc.Row([
        dbc.Col(dcc.Graph(id='sales-bar-chart'), width=12, className='p-0')
    ], className='mt-3 g-0'),

    dbc.Row([
        dbc.Col(dcc.Graph(id='profit-bar-chart'), width=12, className='p-0')
    ], className='mt-3 g-0'),

    dbc.Row([
        dbc.Col(dcc.Graph(id='payment-method-pie-chart'), width=12, className='p-0')
    ], className='mt-3 g-0')
...
def update_graphs(start_date, end_date, selected_categories):
    ...
    return sales_bar_chart, profit_bar_chart, payment_method_pie_chart
